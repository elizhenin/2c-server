window.ЗапросыАПИ = {
    ...
    Отчеты: {
        ...
        ДокументПоДокументу: function (Отчет, НазваниеИсхПериода, НазваниеЦелПериода) {
            var Параметры = {
                type: "exists",
                report: Отчет,
                source: НазваниеИсхПериода,
                period: НазваниеЦелПериода
        ...
        Парсер: {
            ЗначениеЯчейки: function (Отчет, НазваниеПериода, КодОрганизации, Лист, АдресЯчейки){
                var Параметры = {
                    report: Отчет,
                    period: НазваниеПериода,
                    org_id: КодОрганизации,
                    worksheet: Лист,
                    cell: АдресЯчейки
                };
                var ОтветСервера = ЗапросыАПИ.GET.Sync("/documents/parser/read", Параметры, null);
            return ОтветСервера;
            }
        }
    },
